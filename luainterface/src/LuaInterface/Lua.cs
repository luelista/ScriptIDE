...
{    
    ...
    public class Lua : IDisposable
	{
        ...
        int PanicCallback(IntPtr luaState)
        {
           ...
           // OnLuaException(new LuaExceptionEventArgs(new LuaException(reason)));
            throw new LuaException(reason);
        }
        ...
        void ThrowExceptionFromError(int oldTop)
        {
            ...
            if (luaEx != null) {
              throw luaEx;
             // OnLuaException(new LuaExceptionEventArgs(luaEx));
             // return;
            }
            ...
            //OnLuaException(new LuaExceptionEventArgs(new LuaScriptException(err.ToString(), "")));
        }
      ...
      public bool GetStack(int level, out LuaDebug luaDebug)
      {
         ...
         try
         {
           if (LuaDLL.lua_getstack(luaState, level, ld) != 0) {
             GetInfo("nS", ld);
             return true;
           } else {
             return false;
      ...
      /// <returns>see lua docs</returns>
      /// <author>Reinhard Ostermeier</author>
      public int GetInfo(String what, IntPtr ld)
      {
         //IntPtr ld = System.Runtime.InteropServices.Marshal.AllocHGlobal(System.Runtime.InteropServices.Marshal.SizeOf(luaDebug));
         //System.Runtime.InteropServices.Marshal.StructureToPtr(luaDebug, ld, false);
         try
      ...
      public LuaDebug GetDebugFromPointer(IntPtr luaDebug) {
        return (LuaDebug)System.Runtime.InteropServices.Marshal.PtrToStructure(luaDebug, typeof(LuaDebug));
      }
      ...
      /// <returns>see lua docs</returns>
      /// <author>Reinhard Ostermeier</author>
      public String GetLocal(IntPtr ld, int n)
      {
         //IntPtr ld = System.Runtime.InteropServices.Marshal.AllocHGlobal(System.Runtime.InteropServices.Marshal.SizeOf(luaDebug));
         //System.Runtime.InteropServices.Marshal.StructureToPtr(luaDebug, ld, false);
         try
      ...
      /// <returns>see lua docs</returns>
      /// <author>Reinhard Ostermeier</author>
      public String SetLocal(IntPtr ld, int n)
      {
         //IntPtr ld = System.Runtime.InteropServices.Marshal.AllocHGlobal(System.Runtime.InteropServices.Marshal.SizeOf(luaDebug));
         //System.Runtime.InteropServices.Marshal.StructureToPtr(luaDebug, ld, false);
         try
        ...
        try {
          ...
          if (temp != null) {
            ...
            unsafe {
              ec = *((int*)luaDebug);
              // LUA_HOOKLINE = 2
              if (ec == 2) currline = *(((int*)luaDebug) + 1);
            }
            temp(this, new DebugHookEventArgs(luaDebug, (LuaInterface.EventCodes)ec, currline));
          }
        } catch (Exception ex) {
      ...
      /// <summary>
      /// Event that is raised when an exception occures in Lua code.
      /// </summary>
      /// <author>Max Weller</author>
      /*public event EventHandler<LuaExceptionEventArgs> LuaException;
      private void OnLuaException(LuaExceptionEventArgs e) {
        EventHandler<LuaExceptionEventArgs> temp = LuaException;
        if (temp != null) {
          temp(this, e);
        } else {
          throw e.Exception;
   ...
   public class DebugHookEventArgs : EventArgs {
     private readonly IntPtr luaDebug;
     private readonly EventCodes eventCode;
     private readonly int currentline;

      public DebugHookEventArgs(IntPtr luaDebug, EventCodes eventCode, int currentline) {
       this.luaDebug = luaDebug;
       this.eventCode = eventCode;
       this.currentline = currentline;
      }

      public IntPtr LuaDebug {
        get { return luaDebug; }
      }
      public EventCodes EventCode {
   ...
   public class LuaExceptionEventArgs : EventArgs {
     private readonly Exception m_Exception;
     public Exception Exception {
       get { return m_Exception; }
     }

     public LuaExceptionEventArgs(Exception ex) {
       m_Exception = ex;
     }
   }
}
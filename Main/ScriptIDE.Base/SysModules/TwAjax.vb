...
Public Class TwAjax
  ...
  Public Shared Function postUrl(ByVal url As String, ByVal post As String, Optional ByVal cookies As String = "") As String
    Dim xmlhttp As Object = CreateObject("MSXML2.SERVERXMLHTTP.6.0")
    'Dim xmlhttp As Object = CreateObject("Msxml2.XMLHTTP.3.0")
    xmlhttp.setProxy(2, "10.34.0.5:8080", "")
    xmlhttp.Open("POST", url, True)
    xmlhttp.setProxyCredentials("wellmax", "12345")
  ...
  Public Shared Function EncodeUrlParaList(ByVal ht As Hashtable) As String
    Dim sb As New System.Text.StringBuilder
    For Each key In ht.Keys
      sb.Append(key + "=" + HttpUtility.UrlEncode(ht(key)) + "&")
    Next
    Return sb.ToString
  End Function

...
#End Region
  ...
  Function getRTF(ByVal html As String) As String
    ...
    Dim header As String = "{\rtf1\ansi\ansicpg1252\deff0\deflang1031{\fonttbl{\f0\fswiss\fprq0\fcharset0 Segoe UI;}{\f1\fswiss\fprq0\fcharset0 Microsoft Sans Serif;}{\f2\fmodern\fprq1\fcharset0 Courier New;}{\f2\froman\fprq0\fcharset0 Times New Roman;}}"
    ...
    html = html.Replace("</f>", "}")
    html = html.Replace("<ul><li>", "\par<li><ul>")
    html = html.Replace("<ul>", "{\*\pn\pnlvlblt\pnf2\pnindent0{\pntxtb\'B7}}\fi-360\li360 ")
    html = html.Replace("<li>", "{\pntext\f1\'B7\tab}")
    html = html.Replace("</ul>", "\pard")

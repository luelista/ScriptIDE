...
#Region "Identity"
      Public Sub New(ByVal insideTop1__1 As Color, ByVal insideTop2__2 As Color, ByVal insideBottom1__3 As Color, ByVal insideBottom2__4 As Color, ByVal fillTop1__5 As Color, ByVal fillTop2__6 As Color, _
       ByVal fillBottom1__7 As Color, ByVal fillBottom2__8 As Color, ByVal border1__9 As Color, ByVal border2__10 As Color)
...
#Region "Identity"
    ...
    ''' </summary>
    Public Sub New()
      MyBase.New(Office2007ColorTable.GetDefault())
    End Sub
#End Region
...
#Region "OnRenderArrow"
    ...
    Protected Overloads Overrides Sub OnRenderArrow(ByVal e As ToolStripArrowRenderEventArgs)
...
#Region "OnRenderItemCheck"
    ...
    Protected Overloads Overrides Sub OnRenderItemCheck(ByVal e As ToolStripItemImageRenderEventArgs)
...
#Region "OnRenderItemImage"
    ...
    ''' </summary>
    ''' <param name="e">An ToolStripItemImageRenderEventArgs containing the event data.</param>
    Protected Overloads Overrides Sub OnRenderItemImage(ByVal e As ToolStripItemImageRenderEventArgs)
...
#Region "OnRenderToolStripContentPanelBackground"
    ...
    Protected Overloads Overrides Sub OnRenderToolStripContentPanelBackground(ByVal e As ToolStripContentPanelRenderEventArgs)
...
#Region "Implementation"
    ...
    Private Sub DrawGradientToolSplitItem(ByVal g As Graphics, ByVal splitButton As ToolStripSplitButton, ByVal colorsButton As GradientItemColors, ByVal colorsDrop As GradientItemColors, ByVal colorsSplit As GradientItemColors)
      ...
      If (backRect.Width > 0) AndAlso (backRectDrop.Width > 0) AndAlso (backRect.Height > 0) AndAlso (backRectDrop.Height > 0) Then
        ...
        Using borderPath As GraphicsPath = CreateBorderPath(backRect, _cutMenuItemBack)
          ...
          Using splitBrush As New LinearGradientBrush(New Rectangle(backRect.X + splitOffset, backRect.Top, 1, backRect.Height + 1), colorsSplit.Border1, colorsSplit.Border2, 90.0F)
    ...
    Private Sub DrawSeparator(ByVal g As Graphics, ByVal vertical As Boolean, ByVal rect As Rectangle, ByVal lightPen As Pen, ByVal darkPen As Pen, ByVal horizontalInset As Integer, _

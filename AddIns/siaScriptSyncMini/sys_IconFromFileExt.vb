...
Public Class RegisteredFileType
  ...
  Shared Function getImageIndexForFileExt(ByVal iml As ImageList, ByVal fileSpec As String) As Integer
    Dim ext = IO.Path.GetExtension(fileSpec).ToUpper
    If iml.Images.ContainsKey(ext) Then Return iml.Images.IndexOfKey(ext)
